...
def load_setting():
    settings = {
        ...
        'Primary site': {'values': ["Bones of skull and face", "Vertebral column", "Pelvic bones, sacrum, coccyx"], 'type': 'selectbox', 'init_value': 1, 'add_after': ''},
        'Surgery': {'values': ["None", 'Local excision', "Partial resection", "Radical excision"],
                    'type': 'selectbox', 'init_value': 3, 'add_after': ''},
        'Radiotherapy': {'values': ["No", "Yes"], 'type': 'selectbox', 'init_value': 0},
        'Chemotherapy': {'values': ["No", "Yes"], 'type': 'selectbox', 'init_value': 0, 'add_after': '(Chemotherapy)'},
    ...
    input_keys = ['Age', 'Chemotherapy', 'Distant metastasis', 'Primary site', 'Race','Radiotherapy',
        'Surgery','Tumor extension', 'Tumor size']
